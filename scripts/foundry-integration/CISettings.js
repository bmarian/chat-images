...
import {localize, log, MODULE_NAME} from "../CIUtils.js";
...
const UPLOAD_FOLDER_PATH = `uploaded-${MODULE_NAME}`;
 ...
 */
const createFolder = (source, target, options = {}) => {
 ...
 * @return {Promise<Object>}
 */
const createUploadFolderIfMissing = () => {
